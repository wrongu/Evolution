...
public class DumbBrain {
	...
	public static DumbBrain fromGene(Gene<DumbBrain> g, AbstractOrganism org){
		...
		DumbBrain net = g.create(0, 0, null);
		net.gene = g;
		net.meatCase = org;
		return net;
	}
	...
	public static DumbBrain newEmpty(int s, int o, AbstractOrganism org){
		DumbBrain mnn = new DumbBrain(0, s, o, 0.1, 1.0, -0.1, 0.5);
	...
	private class BrainGene extends Gene<DumbBrain>{
		...
		@Override
		public Gene<DumbBrain> mutate(Random r) {
